...
WITH cct_rules_raw AS (
    SELECT * FROM (
        ...
        ('RN', 'Sindágua-RN', 'CAERN', DATE '2020-01-01', DATE '2022-12-31', 30, 0.50, 1.00, 1.00, TRUE, 0.50, 0.70, 0.20, 22, 5, 0.30, 0.40, 40.0, 1.0, 0.0900),
        ('RN', 'Sindágua-RN', 'CAERN', DATE '2022-01-01', DATE '2024-12-31', 30, 0.50, 1.00, 1.00, TRUE, 0.50, 0.70, 0.20, 22, 5, 0.30, 0.40, 40.0, 1.0, 0.1100),
